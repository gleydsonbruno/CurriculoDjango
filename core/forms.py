...
class CurriculoForm(forms.ModelForm):
    class Meta:
        ...
        widgets = {
            ...
            'experiencia': forms.TextInput(attrs={'required': False,'class': 'form-control', 'placeholder':'Insira suas experiências trabalhistas'}),
            ...
            'empresa': forms.TextInput(attrs={'required': False, 'class': 'form-control', 'placeholder':'Nome da empresa'}),
            'cargo': forms.TextInput(attrs={'required': False,'class': 'form-control', 'placeholder':'Cargo que exercia'}),
            'periodo': forms.TextInput(attrs={'required': False,'class': 'form-control', 'placeholder':'Tempo que passou na empresa'}),
